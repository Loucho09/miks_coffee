                        ...
                        <tbody class="divide-y divide-stone-100 dark:divide-stone-800">
                            @foreach($products as $product)
                                <tr class="hover:bg-stone-50 dark:hover:bg-stone-800/50 transition">
                                    <td class="py-4 px-6">
                                        <div class="w-12 h-12 rounded-lg bg-stone-100 dark:bg-stone-800 overflow-hidden border border-stone-200 dark:border-stone-700">
                                            @if($product->image)
                                    ...
                                    <td class="py-4 px-6 font-bold text-stone-900 dark:text-white">{{ $product->name }}</td>
                                    <td class="py-4 px-6">
                                    ...
                                    <td class="py-4 px-6 text-stone-700 dark:text-stone-300">₱{{ number_format($product->price, 2) }}</td>
