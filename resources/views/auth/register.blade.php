        ...
        <div class="flex flex-col justify-center w-full lg:w-1/2 px-8 lg:px-24 py-12 bg-white dark:bg-stone-900">
            <div class="w-full max-w-md mx-auto">
                ...
                <div class="mb-10">
                    ...
                    <h2 class="text-3xl font-bold text-stone-900 dark:text-white tracking-tight">Create an account</h2>
                    <p class="text-stone-500 dark:text-stone-400 mt-2 text-sm">Join us to earn rewards and order faster.</p>
                </div>
                ...
                <form method="POST" action="{{ route('register') }}" class="space-y-5" x-data="{ showPass: false, showConfirm: false }">
                    ...
                    <button type="submit" class="w-full bg-amber-600 hover:bg-amber-700 text-white font-bold py-3.5 rounded-xl shadow-lg hover:shadow-xl hover:scale-[1.01] transition transform active:scale-95">
                        Create Account
                    </button>
                </form>
                ...
                <div class="mt-8 text-center border-t border-stone-100 dark:border-stone-800 pt-6">
                    <p class="text-stone-500 dark:text-stone-400 text-sm">
                        ...
                        <a href="{{ route('login') }}" class="text-amber-600 hover:text-amber-700 font-bold hover:underline ml-1">
                            Sign In
                        </a>
                    </p>
                </div>
