                            ...
                            <div class="bg-white dark:bg-stone-900 p-4 rounded-2xl shadow-sm border border-stone-100 dark:border-stone-800 flex items-center justify-between">
                                <div class="flex items-center gap-4">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-sm text-stone-500 dark:text-stone-400">PHP {{ number_format($details['price'], 2) }} x {{ $details['quantity'] }}</p>
                                    </div>
                                </div>
                                    ...
                                    @if($canRedeem)
                                        <label class="flex items-center gap-3 cursor-pointer select-none">
                                            ...
                                            <div class="text-sm text-stone-600 dark:text-stone-300">
                                                ...
                                                <span class="text-green-600 dark:text-green-400 font-bold">PHP 50.00 OFF</span>
                                            </div>
                                        </label>
                                    @else
