<div>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-10">
        ...
        <div class="p-10 rounded-[3rem] bg-stone-900 text-white shadow-2xl relative overflow-hidden group">
            ...
            <div class="relative z-10">
                ...
                <h3 class="text-2xl font-bold mb-10 tracking-tight">Best Sellers</h3>
                ...
                <div class="space-y-4">
                    <div class="flex items-center justify-between p-5 rounded-2xl bg-stone-800/40 border border-stone-700 hover:border-amber-500/30 transition-all duration-300 group/item">
                        ...
                        <span class="text-xs font-black text-amber-500 uppercase tracking-widest bg-amber-500/10 px-2 py-1 rounded-lg">Top Pick</span>
                    </div>
                    ...
                    <div class="flex items-center justify-between p-5 rounded-2xl bg-stone-800/40 border border-stone-700 hover:border-amber-500/30 transition-all duration-300 group/item">
                        ...
                        <span class="text-[10px] font-black text-stone-500 uppercase tracking-widest">Rising</span>
                    </div>
                </div>

                <div class="mt-12 pt-8 border-t border-stone-800">
                    <p class="text-[10px] text-stone-500 font-bold uppercase tracking-[0.2em] mb-4 text-center">System Overview</p>
