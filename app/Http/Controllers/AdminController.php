...
class AdminController extends Controller
{
     ...
     * Optimized for high-speed verification and database persistence.
     */
    public function processScan(Request $request)
    {
        ...
        try {
            DB::transaction(function () use ($order) {
                ...
                // Award stars (10 by default) - Using manual save to ensure persistence
            ...
            return response()->json(['success' => false, 'message' => 'Operational Failure: Points could not be added.']);
        }
    }
}